...
export const PasswordInput = forwardRef<FormElementRef, TextInputProps>(
  (
    ...
    const inputClasses = cn(
      'w-full direction-auto px-3 py-2 pr-10 border rounded-lg border-gray-300 bg-white text-sm ring-offset-background placeholder:text-gray-500 transition-colors',
