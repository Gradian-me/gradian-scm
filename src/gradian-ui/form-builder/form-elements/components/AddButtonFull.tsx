...
export const AddButtonFull: React.FC<AddButtonFullProps> = ({
  ...
  return (
    <Button
      ...
      className={cn(
        'flex items-center justify-center px-4 py-3 border-2 border-dashed border-gray-300 rounded-lg text-gray-600 hover:border-violet-400 hover:text-violet-600 hover:bg-violet-200 dark:hover:bg-violet-200 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed',
        fullWidth && 'w-full',
        textSize,
        className
      )}
