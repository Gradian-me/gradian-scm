...
export function FieldEditor({
  ...
  const toggleNameCustomization = () => {
    setIsNameCustom((prev) => {
      const next = !prev;
      if (!next) {
        // Reset to auto-generated name when turning customization off
        const autoGeneratedName = labelToCamelCase(tempField.label || '');
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="flex flex-col gap-2">
                  <div className="flex items-center justify-between">
                    ...
                    >
                      {isNameCustom ? 'Use generated' : 'Customize'}
                    </Button>
                  </div>
                  <TextInput
                    config={{
                    ...
                    className="h-9"
                    disabled={!isNameCustom}
                  />
                  {!isNameCustom && (
                    <p className="text-xs text-gray-500">
                      Field name auto-generates from the label. Click “Customize” to override.
                    </p>
                  )}
                </div>
              </div>
