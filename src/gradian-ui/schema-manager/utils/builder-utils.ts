...
export const FIELD_TYPES: Array<{
  ...
  { value: 'checkbox', label: 'Checkbox', description: 'Single checkbox option' },
  ...
  { value: 'phone', label: 'Phone (alias)', description: 'Telephone number input (alias for tel)' },
  ...
  { value: 'icon-input', label: 'Icon Input', description: 'Icon input component with picker' },
  ...
  { value: 'input', label: 'Input', description: 'Generic input component' },
